...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_user_id"], ["users.id"], name="operation_types_ibfk_1"
        ),
        sa.ForeignKeyConstraint(
            ["edited_user_id"], ["users.id"], name="operation_types_ibfk_2"
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
        mysql_default_charset="utf8mb4",
    ...
    op.create_table(
        ...
        sa.Column("edited_at", mysql.DATETIME(), nullable=False),
        sa.ForeignKeyConstraint(
            ["created_user_id"], ["users.id"], name="billets_ibfk_1"
        ),
        sa.ForeignKeyConstraint(
            ["edited_user_id"], ["users.id"], name="billets_ibfk_2"
        ),
    ...
    op.create_table(
        ...
        sa.Column("edited_at", mysql.DATETIME(), nullable=False),
        sa.ForeignKeyConstraint(
            ["created_user_id"], ["users.id"], name="operations_ibfk_1"
        ),
        sa.ForeignKeyConstraint(
            ["edited_user_id"], ["users.id"], name="operations_ibfk_2"
        ),
        sa.ForeignKeyConstraint(
            ["leader_user_id"], ["users.id"], name="operations_ibfk_4"
        ),
        sa.ForeignKeyConstraint(["game_id"], ["games.id"], name="operations_ibfk_3"),
        sa.ForeignKeyConstraint(
            ["type_id"], ["operation_types.id"], name="operations_ibfk_5"
        ),
        sa.PrimaryKeyConstraint("id"),
        mysql_collate="utf8mb4_general_ci",
        mysql_default_charset="utf8mb4",
    ...
    op.create_table(
        ...
        sa.Column("edited_at", mysql.DATETIME(), nullable=False),
        sa.ForeignKeyConstraint(
            ["created_user_id"], ["users.id"], name="member_games_ibfk_1"
        ),
        sa.ForeignKeyConstraint(
            ["edited_user_id"], ["users.id"], name="member_games_ibfk_2"
        ),
